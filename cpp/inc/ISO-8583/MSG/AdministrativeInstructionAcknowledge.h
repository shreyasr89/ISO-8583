/*
 * AdministrativeInstructionAcknowledge.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef AdministrativeInstructionACKNOWLEDGE_H_
#define AdministrativeInstructionACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Administrative, InstructionAcknowledge)
	}
}
