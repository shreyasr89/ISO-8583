/*
 * AuthorizationInstructionAcknowledge.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef AuthorizationInstructionACKNOWLEDGE_H_
#define AuthorizationInstructionACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Authorization, InstructionAcknowledge)
	}
}
