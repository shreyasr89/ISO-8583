/*
 * ReversalInstructionAcknowledge.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef ReversalInstructionACKNOWLEDGE_H_
#define ReversalInstructionACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Reversal, InstructionAcknowledge)
	}
}
