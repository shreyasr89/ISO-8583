/*
 * ReconciliationInstructionAcknowledge.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef ReconciliationInstructionACKNOWLEDGE_H_
#define ReconciliationInstructionACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Reconciliation, InstructionAcknowledge)
	}
}
