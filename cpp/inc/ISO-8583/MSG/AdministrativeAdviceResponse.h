/*
 * AdministrativeAdviceResponse.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef AdministrativeAdviceRESPONSE_H_
#define AdministrativeAdviceRESPONSE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Administrative, AdviceResponse)
	}
}
