/*
 * AuthorizationAdviceResponse.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef AuthorizationAdviceRESPONSE_H_
#define AuthorizationAdviceRESPONSE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Authorization, AdviceResponse)
	}
}
