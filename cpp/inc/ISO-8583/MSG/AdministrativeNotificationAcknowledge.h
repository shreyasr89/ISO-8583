/*
 * AdministrativeNotificationAcknowledge.h
 *
 *  Created on: 17 juil. 2015
 *      Author: FrancisANDRE
 */

#ifndef AdministrativeNotificationAcknowledge_H_
#define AdministrativeNotificationAcknowledge_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Administrative, NotificationAcknowledge)
	}
}
