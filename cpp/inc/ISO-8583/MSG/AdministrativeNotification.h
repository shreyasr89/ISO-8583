/*
 * AdministrativeNotification.h
 *
 *  Created on: 17 juil. 2015
 *      Author: FrancisANDRE
 */

#ifndef AdministrativeNotification_H_
#define AdministrativeNotification_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Administrative, Notification)
	}
}
