/*
 * ReconciliationNotificationAcknowledge.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef ReconciliationNotificationACKNOWLEDGE_H_
#define ReconciliationNotificationACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Reconciliation, NotificationAcknowledge)
	}
}
