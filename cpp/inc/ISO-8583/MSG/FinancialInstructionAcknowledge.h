/*
 * FinancialInstructionAcknowledge.h
 *
 *  Created on: 11 août 2015
 *      Author: FrancisANDRE
 */

#ifndef FINANCIALINSTRUCTIONACKNOWLEDGE_H_
#define FINANCIALINSTRUCTIONACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Financial, InstructionAcknowledge)
	}
}
