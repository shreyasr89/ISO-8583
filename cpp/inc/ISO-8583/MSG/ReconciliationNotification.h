/*
 * ReconciliationNotification.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef ReconciliationNotification_H_
#define ReconciliationNotification_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Reconciliation, Notification)
	}
}
