/*
 * ReversalNotificationAcknowledge.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef ReversalNotificationACKNOWLEDGE_H_
#define ReversalNotificationACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Reversal, NotificationAcknowledge)
	}
}
