/*
 * AuthorizationNotificationAcknowledge.h
 *
 *  Created on: 10 août 2015
 *      Author: FrancisANDRE
 */

#ifndef AuthorizationNotificationACKNOWLEDGE_H_
#define AuthorizationNotificationACKNOWLEDGE_H_
...
namespace ISO_8583 {
	namespace MSG {
		MESSAGE_CLASS_DEFINITION(Authorization, NotificationAcknowledge)
	}
}
